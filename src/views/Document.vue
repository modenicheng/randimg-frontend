<template>
  <v-container class="doc-root">
    <h1 class="text-h4">随机图片 API 文档</h1>
    ...
    <v-card variant="tonal" class="mb-2"><v-card-text><pre>{
  "id": 123,
  "title": "string",
  "src": "https://...",
  "source_id": 999,
  ...
  "colors": {
    ...
    <div class="pl-4">
      ...
      <v-list density="compact" variant="text">
        ...
        <v-list-item><code class="text-primary font-weight-bold">accessible</code>: <code class="text-primary font-weight-bold">true</code>/<code class="text-primary font-weight-bold">false</code>/<code class="text-primary font-weight-bold">all</code></v-list-item>
      ...
      <v-card variant="tonal" class="mb-2"><v-card-text><pre>{ "access_token": "...", "token_type": "bearer" }</pre></v-card-text></v-card>
      ...
      <v-card variant="tonal" class="mb-2"><v-card-text><pre>{ "illust_count": 123, "tag_count": 456, "author_count": 78 }</pre></v-card-text></v-card>
    </div>
